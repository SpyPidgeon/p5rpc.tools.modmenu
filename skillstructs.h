...
enum class TargetRestrictions : uint8_t
{
	NoRestrictions,
	RandomTwo,
	DreadfulScreamRelated,
	WingBlastRelated = 4,
	SelfOnly = 16,
	SelfNotAllowed = 32,
	UnconsciousOnly = 64
...
enum class Elements : uint8_t
{
	...
	Healing,
	Support,
	EnemySupport_UNKNOWN,
	Passive = 255
};

enum class ElementSkillType : uint8_t
{
	Passive,
	Active,
	NULLSkill = 255
